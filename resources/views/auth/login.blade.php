            ...
            <div class="col-xl-4 offset-xl-4 col-md-12 col-12">
              <div class="text-center">
                ...
                <p class="mb-0">
                  ...
                  <a href="{{ route('auth.register') }}" class="text-primary">Register here</a>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-12">
              <div class="card card-lg mb-6">
                <div class="card-body p-6">
                  ...
                  <form class="needs-validation mb-6" novalidate method="POST" action="{{ route('auth.login') }}">
                    @csrf
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="signinEmailInput" value="{{ old('email') }}" required autofocus />
                      @error('email')
                    ...
                    <div class="mb-4 d-flex align-items-center justify-content-between">
                      ...
                      <div><a href="{{ route('auth.forgot-password') }}" class="text-primary">Forgot Password</a></div>
                    </div>
