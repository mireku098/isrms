            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-12">
              <div class="card shadow-sm mb-4">
                <div class="card-body p-6">
                  ...
                  <form class="needs-validation mb-6" novalidate method="POST" action="{{ route('auth.register') }}">
                    @csrf
                    <div class="mb-3">
                      <label for="signupFullnameInput" class="form-label">Full Name</label>
                      <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="signupFullnameInput" value="{{ old('name') }}" required />
                      @error('name')
                    ...
                    <div class="mb-3">
                      ...
                      <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="signupEmailInput" value="{{ old('email') }}" required />
                      @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                      @enderror
                    </div>
                    ...
                    <div class="mb-3">
                      ...
                      <select name="role" id="signupRoleInput" class="form-select @error('role') is-invalid @enderror" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="password-field position-relative">
                                <input type="password" name="password" class="form-control fakePassword @error('password') is-invalid @enderror" id="formSignUpPassword" required />
              ...
              <span>
                ...
                <a href="{{ route('auth.login') }}" class="text-primary">Sign in here.</a>
              </span>
            </div>
          </div>
        </div>
