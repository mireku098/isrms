...
@section('title', 'Issue Items from Approved Requisitions')
            ...
            <form action="{{ route('issues.store') }}" method="POST" id="issueForm">
                ...
                <div class="mb-4 pb-4 border-bottom">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="requisition_id" id="requisition_id" class="form-select @error('requisition_id') is-invalid @enderror" required>
                            <option value="" selected disabled>Choose a requisition...</option>
                            @foreach($requisitions as $req)
                                <option value="{{ $req['id'] }}" data-items-count="{{ $req['items_count'] }}" {{ old('requisition_id') == $req['id'] ? 'selected' : '' }}>
                                    {{ $req['requisition_number'] }} - {{ $req['department'] }} ({{ $req['items_count'] }} items)
                                </option>
                            @endforeach
                        </select>
                ...
                <div class="mb-4 pb-4 border-bottom" id="receiverContainer" style="display: none;">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="receiver_name" class="form-label fw-semibold small text-secondary">Receiver/Collector Name</label>
                                <input type="text" name="receiver_name" id="receiver_name" class="form-control @error('receiver_name') is-invalid @enderror" placeholder="Name of person receiving items" value="{{ old('receiver_name') }}">
                                @error('receiver_name')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="receiver_signature" class="form-label fw-semibold small text-secondary">Digital Signature/Initial</label>
                                <input type="text" name="receiver_signature" id="receiver_signature" class="form-control @error('receiver_signature') is-invalid @enderror" placeholder="Type initials or signature" value="{{ old('receiver_signature') }}">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="remarks" id="remarks" class="form-control @error('remarks') is-invalid @enderror" placeholder="Any additional notes..." value="{{ old('remarks') }}">
                                @error('remarks')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="d-flex justify-content-end gap-2 mt-4">
                    <a href="{{ route('issues.index') }}" class="btn btn-ghost">Cancel</a>
