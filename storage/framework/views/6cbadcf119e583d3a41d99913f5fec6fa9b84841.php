...
<html lang="en">
  <head>
    ...
    <title>Sign In | ISRMS - Integrated Store & Requisition Management System</title>
            ...
            <div class="col-xl-4 offset-xl-4 col-md-12 col-12">
              <div class="text-center">
                ...
                <p class="mb-0">
                  ...
                  <a href="<?php echo e(route('auth.register')); ?>" class="text-primary">Register here</a>
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="col-xl-5 col-lg-6 col-md-8 col-12">
              <div class="card card-lg mb-6">
                <div class="card-body p-6">
                  ...
                  <form class="needs-validation mb-6" novalidate method="POST" action="<?php echo e(route('auth.login')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" id="signinEmailInput" value="<?php echo e(old('email')); ?>" required autofocus />
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-4 d-flex align-items-center justify-content-between">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="remember" id="rememberMeCheckbox" <?php echo e(old('remember') ? 'checked' : ''); ?> />
                        <label class="form-check-label" for="rememberMeCheckbox">Remember me</label>
                      </div>

                      <div><a href="<?php echo e(route('auth.forgot-password')); ?>" class="text-primary">Forgot Password</a></div>
                    </div>
...
<?php /**PATH C:\xampp74\htdocs\store_management\resources\views/auth/login.blade.php ENDPATH**/ ?>