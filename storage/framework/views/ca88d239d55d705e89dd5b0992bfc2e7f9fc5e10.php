...
<div class="row justify-content-center g-6">
    <div class="col-xl-10">
        ...
        <form action="<?php echo e(route('requisitions.store')); ?>" method="POST" id="requisitionForm">
            <?php echo csrf_field(); ?>
            <div class="row g-6">
                <!-- Request Info -->
                <div class="col-md-4">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Request Details','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Request Details','class' => 'border-0 shadow-sm']); ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['label' => 'Department','name' => 'department','value' => ''.e(old('department', auth()->user()->department)).'','placeholder' => 'Enter department name','required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => 'Department','name' => 'department','value' => ''.e(old('department', auth()->user()->department)).'','placeholder' => 'Enter department name','required' => true]); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['label' => 'Requested By','name' => 'requested_by','value' => ''.e(auth()->user()->name ?? 'Current User').'','readonly' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => 'Requested By','name' => 'requested_by','value' => ''.e(auth()->user()->name ?? 'Current User').'','readonly' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['label' => 'Date','name' => 'request_date','type' => 'date','value' => ''.e(old('request_date', date('Y-m-d'))).'','required' => true]]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => 'Date','name' => 'request_date','type' => 'date','value' => ''.e(old('request_date', date('Y-m-d'))).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
unset($__errorArgs, $__bag); ?>" rows="3" placeholder="e.g. For new staff onboarding" required><?php echo e(old('purpose')); ?></textarea>
...
<?php endif; ?>
                ...
                <div class="col-md-8">
                    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Requested Items (Live Inventory)','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Requested Items (Live Inventory)','class' => 'border-0 shadow-sm']); ?>
...
unset($__errorArgs, $__bag); ?>" name="items[0][item_id]" data-stock-display data-index="0" style="margin-top: 0.5rem;">
                                        <option value="" selected disabled>Choose Item...</option>
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($item->id); ?>" data-stock="0" data-name="<?php echo e($item->name); ?>" <?php echo e(old('items.0.item_id') == $item->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" class="form-control qty-input <?php $__errorArgs = ['items.0.quantity_requested'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="items[0][quantity_requested]" min="1" value="<?php echo e(old('items.0.quantity_requested', 1)); ?>" required>
                                    <?php $__errorArgs = ['items.0.quantity_requested'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-4 border-top pt-4 text-end">
                            <a href="<?php echo e(route('requisitions.index')); ?>" class="btn btn-ghost">Cancel</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp74\htdocs\store_management\resources\views/requisitions/create.blade.php ENDPATH**/ ?>