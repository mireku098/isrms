    ...
    <ul class="list-unstyled d-flex align-items-center mb-0 gap-2">
      ...
      <li class="ms-3 dropdown">
        <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          <img src="<?php echo e(asset('assets/images/avatar/avatar-1.jpg')); ?>" alt="" class="avatar avatar-sm rounded-circle" />
        </a>
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-0">
          <div>
            <div class="d-flex gap-3 align-items-center border-dashed border-bottom px-4 py-4">
              <img src="<?php echo e(asset('assets/images/avatar/avatar-1.jpg')); ?>" alt="" class="avatar avatar-md rounded-circle" />
              <div>
                <h4 class="mb-0 fs-5"><?php echo e(auth()->user()->name ?? 'User'); ?></h4>
                <p class="mb-0 text-secondary small"><?php echo e(auth()->user()->email ?? 'user@isrms.com'); ?></p>
              </div>
            </div>
            <div class="p-3 d-flex flex-column gap-1">
              <a href="<?php echo e(route('dashboard')); ?>" class="dropdown-item d-flex align-items-center gap-2">
              ...
              <a href="<?php echo e(route('users.show', auth()->id() ?? 1)); ?>" class="dropdown-item d-flex align-items-center gap-2">
                <span><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
...
<?php /**PATH C:\xampp74\htdocs\store_management\resources\views/partials/header.blade.php ENDPATH**/ ?>