...
<?php $__env->startSection('title', 'Principal Dashboard'); ?>
...
<div class="row mb-6 g-6">
    <div class="col-12">
        <div>
            ...
            <p class="text-secondary"><?php echo e(date('l, F j, Y')); ?> - Review and approve pending requests</p>
        </div>
    </div>
...
<?php $component->withAttributes(['class' => 'border-0 shadow-sm h-100']); ?>
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    ...
                    <div class="fs-4 fw-bold"><?php echo e($stats['pending_requisitions']); ?></div>
                </div>
            </div>
...
<?php endif; ?>
    ...
    <div class="col-12">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Pending Requisitions for Approval','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Pending Requisitions for Approval','class' => 'border-0 shadow-sm']); ?>
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="pendingRequisitionsTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $stats['pending_requisition_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td><?php echo e($req->requisitionItems->count()); ?> items</td>
                            ...
                            <td>
                                <div class="d-flex gap-2">
                                    ...
                                    <form action="<?php echo e(route('requisitions.approve', $req)); ?>" method="POST" style="display: inline;">
                                        <?php echo csrf_field(); ?>
                                        <button type="submit" class="btn btn-sm btn-success" onclick="return confirm('Approve this requisition?')">Approve</button>
                                    </form>
                                    <button type="button" class="btn btn-sm btn-outline-danger" data-bs-toggle="modal" data-bs-target="#rejectModal<?php echo e($req->id); ?>">
                                        Reject
                                    </button>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Reject Requisition <?php echo e($req->requisition_number); ?></h5>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                            </div>
                                            <form action="<?php echo e(route('requisitions.reject', $req)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <div class="col-12">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Recent Activity (History)','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Recent Activity (History)','class' => 'border-0 shadow-sm']); ?>
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="recentRequisitionsTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo e($req->created_at->format('M d, Y')); ?></td>
                            <td>
                                <span class="badge <?php echo e($req->status === 'approved' ? 'bg-success' : 'bg-danger'); ?>">
...
<?php endif; ?>
    ...
    <div class="col-12">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Pending SRA Approvals','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Pending SRA Approvals','class' => 'border-0 shadow-sm']); ?>
            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.alert','data' => ['type' => 'info','message' => 'After Storekeeper and Auditor signatures, these require your final approval before they can be printed.']]); ?>
<?php $component->withName('alert'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'info','message' => 'After Storekeeper and Auditor signatures, these require your final approval before they can be printed.']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
            ...
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0" id="pendingSrasTable">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $stats['pending_sra_list']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sra): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td class="fw-semibold"><?php echo e($sra->sra_number); ?></td>
                            <td><?php echo e($sra->supplier_details); ?></td>
                            <td><?php echo e($sra->sraItems->count()); ?></td>
                            <td><?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.badge','data' => ['type' => 'success','text' => '✓ Signed']]); ?>
<?php $component->withName('badge'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['type' => 'success','text' => '✓ Signed']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?></td>
                            <td>
                                <div class="d-flex gap-2">
                                    <a href="<?php echo e(route('sra.show', $sra)); ?>" class="btn btn-sm btn-outline-primary">View</a>
                                    <form action="<?php echo e(route('sra.approve', $sra)); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php endif; ?>
    ...
    <div class="col-lg-8">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Approval Trends','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Approval Trends','class' => 'border-0 shadow-sm']); ?>
...
<?php endif; ?>
    ...
    <div class="col-lg-4">
        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.card','data' => ['title' => 'Quick Stats','class' => 'border-0 shadow-sm']]); ?>
<?php $component->withName('card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['title' => 'Quick Stats','class' => 'border-0 shadow-sm']); ?>
            <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                <span>Approvals Today:</span>
                <strong id="approvalsToday"><?php echo e($stats['approvals_today']); ?></strong>
            </div>
            <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                <span>This Week:</span>
                <strong id="approvalsThisWeek"><?php echo e($stats['approvals_this_week']); ?></strong>
            </div>
            <div class="d-flex justify-content-between mb-2 pb-2 border-bottom">
                <span>This Month:</span>
                <strong id="approvalsThisMonth"><?php echo e($stats['approvals_this_month']); ?></strong>
            </div>
            <div class="d-flex justify-content-between">
                <span>Approval Rate:</span>
                <strong class="text-success" id="approvalRate"><?php echo e($stats['approval_rate']); ?>%</strong>
            </div>
         <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp74\htdocs\store_management\resources\views/dashboard/principal.blade.php ENDPATH**/ ?>