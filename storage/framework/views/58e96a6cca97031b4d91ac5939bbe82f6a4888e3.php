...
<?php $component->withAttributes(['class' => 'border-0 shadow-sm']); ?>
            <form action="<?php echo e(route('categories.update', $category->id)); ?>" method="POST">
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'components.input','data' => ['label' => 'Category Name','name' => 'name','placeholder' => 'e.g. Furniture','value' => ''.e(old('name', $category->name)).'','required' => true,'error' => ''.e($errors->first('name')).'']]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes(['label' => 'Category Name','name' => 'name','placeholder' => 'e.g. Furniture','value' => ''.e(old('name', $category->name)).'','required' => true,'error' => ''.e($errors->first('name')).'']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp74\htdocs\store_management\resources\views/categories/edit.blade.php ENDPATH**/ ?>